...
public class F1_Noob {
  ...
  public F1_Noob(Player player, int index, boolean giveKit) {
    this.player = player;
    this.index = index;
    if (giveKit) {
  ...
  public static void makeNoob() {
    ...
    displays = new Material[] {Material.GOLDEN_SWORD, Material.STONE_SWORD, Material.IRON_SWORD,
    ...
    kitMenu =
      Bukkit.createInventory(null, 45, ChatColor.DARK_BLUE + "" + ChatColor.BOLD + "Noob Legend");
    buyMenu = Bukkit.createInventory(null, 45,
      ChatColor.DARK_BLUE + "" + ChatColor.BOLD + "Buy This Level Noob");
