...
public class D_SpawnShopSelectors {
	...
	private static Location[] locations = {
			new Location(Main.hub, -1073.5, 193.5, -110.5, -120, 0),
			new Location(Main.hub, -1077.5, 193.5, -113.5, -100, 0),
			new Location(Main.hub, -1077.5, 193.5, -119.5, -80, 0),
			new Location(Main.hub, -1073.5, 193.5, -122.5, -60, 0)
	};
