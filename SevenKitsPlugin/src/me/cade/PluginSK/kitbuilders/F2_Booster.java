...
public class F2_Booster {
  ...
  public F2_Booster(Player player, int index, boolean giveKit) {
    this.player = player;
    this.index = index;
    if (giveKit) {
  ...
  public static void makeBooster() {
    ...
    kitMenu = Bukkit.createInventory(null, 45,
      ChatColor.DARK_BLUE + "" + ChatColor.BOLD + "Booster Legend");
    buyMenu = Bukkit.createInventory(null, 45,
      ChatColor.DARK_BLUE + "" + ChatColor.BOLD + "Buy This Level Booster");
