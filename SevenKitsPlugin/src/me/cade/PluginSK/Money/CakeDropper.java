...
public class CakeDropper {
  ...
  private static final Location iceSpawn = new Location(Main.hub, -1014.5, 65.5, -143.5);
  private static final Location grassSpawn = new Location(Main.hub, -1057.5, 65.5, -101.5);
  private static final Location sandSpawn = new Location(Main.hub, -1092.5, 65.5, -93.5);
  ...
  private static void spawnCakes() {
    sumUpCakesInArea((ArrayList<Entity>) Main.hub.getNearbyEntities(iceSpawn, 5, 5, 5), iceSpawn);
    sumUpCakesInArea((ArrayList<Entity>) Main.hub.getNearbyEntities(grassSpawn, 5, 5, 5),
      grassSpawn);
    sumUpCakesInArea((ArrayList<Entity>) Main.hub.getNearbyEntities(sandSpawn, 5, 5, 5), sandSpawn);
  }
  ...
  private static void clearCakeAreas() {
    clearEachArea((ArrayList<Entity>) Main.hub.getNearbyEntities(iceSpawn, 5, 5, 5), iceSpawn);
    clearEachArea((ArrayList<Entity>) Main.hub.getNearbyEntities(grassSpawn, 5, 5, 5), grassSpawn);
    clearEachArea((ArrayList<Entity>) Main.hub.getNearbyEntities(sandSpawn, 5, 5, 5), sandSpawn);
  }
